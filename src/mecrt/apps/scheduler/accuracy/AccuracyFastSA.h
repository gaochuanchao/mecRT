...
#ifndef _MECRT_SCHEDULER_SCHEME_ACCURACY_FAST_SA_H_
#define _MECRT_SCHEDULER_SCHEME_ACCURACY_FAST_SA_H_

#include "mecrt/apps/scheduler/accuracy/AccuracyGreedy.h"

class AccuracyFastSA : public AccuracyGreedy
{
  protected:
  ...
  public:
    AccuracyFastSA(Scheduler *scheduler);
    ~AccuracyFastSA() 
    {
...
#endif // _MECRT_SCHEDULER_SCHEME_ACCURACY_FAST_SA_H_