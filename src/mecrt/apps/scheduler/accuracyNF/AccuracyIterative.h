...
#ifndef _MECRT_SCHEDULER_SCHEME_ACCURACY_NF_ITERATIVE_H_
#define _MECRT_SCHEDULER_SCHEME_ACCURACY_NF_ITERATIVE_H_

#include "mecrt/apps/scheduler/accuracy/AccuracyGreedy.h"

class AccuracyIterative : public AccuracyGreedy
{
  protected:
  ...
  public:
    AccuracyIterative(Scheduler *scheduler);
    ~AccuracyIterative() {
...
#endif // _MECRT_SCHEDULER_SCHEME_ACCURACY_NF_ITERATIVE_H_
