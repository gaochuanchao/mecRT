...
//
// a single layer of LteSchedulerEnbDl class in simu5g
// simulate the MAC stack of the NIC module of gNB
// LteSchedulerEnb --> LteSchedulerEnbDl
//

#ifndef _LTE_GNB_SCHEDULER_DL_H_
#define _LTE_GNB_SCHEDULER_DL_H_
 ...
 *
 * 5G gNB downlink scheduler.
 * Note that this is not a OMNET module.
 */
class GnbSchedulerDl : public LteSchedulerEnbDl
{
  ...
  protected:
     ...
     */
    virtual bool racschedule(double carrierFrequency, BandLimitVector* bandLim = NULL) override { return false; }
