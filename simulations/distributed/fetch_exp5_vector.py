...
INPUT_DIR = os.path.join(WORKING_DIR, "results/EXP5")
OUTPUT_DIR = os.path.join(WORKING_DIR, "result-analysis/EXP5")
# Ensure output directory exists
os.makedirs(OUTPUT_DIR, exist_ok=True)

# Regex patterns to extract fields from filename
# file name example:  DistIS-mapScale-2-interval-5.sca, DistIS-mapScale-2-interval-5.vec
MATCH_PATTERN = re.compile(r'DistIS-mapScale-([0-9]+)-interval-([0-9]+)')
...
def distributed_summary_app_count():
    ...
    with open(output_csv, mode='w', newline='') as csvfile:
        ...
        csv_writer.writerow(["mapScale", "interval", "time", "algorithm"] + params_list)
        ...
        for filename in os.listdir(INPUT_DIR):
            ...
            for t in timeList:
                row = [mapScale, interval, t, "DistIS"]
