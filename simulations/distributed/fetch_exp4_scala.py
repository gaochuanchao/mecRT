...
def extract_expected_utility():
    ...
    with open(output_csv, mode='w', newline='') as csvfile:
        ...
        csv_writer.writerow(["algorithm", "mapScale", "ueSortingScheme", "utility"])
        ...
        for filename in os.listdir(INPUT_DIR):
            ...
            mapScale = file_match.group(1)
            ueSortingScheme = file_match.group(2)
            ...
            csv_writer.writerow(["DistIS", mapScale, ueSortingScheme, value])
...
def extract_expected_job_count():
    ...
    with open(output_csv, mode='w', newline='') as csvfile:
        csv_writer = csv.writer(csvfile)
        csv_writer.writerow(["algorithm", "mapScale", "ueSortingScheme", "job_count"])
...
def extract_improved_utility():
    ...
    with open(output_csv, mode='w', newline='') as csvfile:
        csv_writer = csv.writer(csvfile)
        csv_writer.writerow(["algorithm", "mapScale", "ueSortingScheme", "utility:mean", "meetDlPkt:mean", "jobGeneratedSinceGranted:mean"])
        ...
        for filename in os.listdir(INPUT_DIR):
            ...
            csv_writer.writerow(["DistIS", mapScale, ueSortingScheme] + [values[param] for param in params_list])
