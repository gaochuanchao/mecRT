...
#
# check the impact of different schedule intervals for accessible RSUs on the distributed scheduling performance
#
import os
import re
import csv
...
def extract_expected_utility():
    ...
    with open(output_csv, mode='w', newline='') as csvfile:
        ...
        csv_writer.writerow(["algorithm", "mapScale", "interval", "utility"])
        ...
        for filename in os.listdir(INPUT_DIR):
            ...
            csv_writer.writerow(["DistIS", mapScale, interval, value])
...
def extract_expected_job_count():
    ...
    with open(output_csv, mode='w', newline='') as csvfile:
        csv_writer = csv.writer(csvfile)
        csv_writer.writerow(["algorithm", "mapScale", "interval", "job_count"])
...
def extract_improved_utility():
    ...
    with open(output_csv, mode='w', newline='') as csvfile:
        csv_writer = csv.writer(csvfile)
        csv_writer.writerow(["algorithm", "mapScale", "interval", "utility:mean", "meetDlPkt:mean", "jobGeneratedSinceGranted:mean"])
        ...
        for filename in os.listdir(INPUT_DIR):
            ...
            csv_writer.writerow(["DistIS", mapScale, interval] + [values[param] for param in params_list])
