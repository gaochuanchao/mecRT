...
# file name:  FastSA-appCount-4-errorProb-0.1.sca, FastSA-appCount-4-errorProb-0.1.vec
# appCount: 4, errorProb: 0.1
prob_pattern = re.compile(r'appCount-4-errorProb-([0-9.]+)')
...
def collect_link_failure():
    ...
    with open(output_csv, mode='w', newline='') as csvfile:
        ...
        for filename in os.listdir(input_dir):
            ...
            prob_match = prob_pattern.search(filename)
            if not prob_match:
                continue
        ...
        # Loop through .vec files in input_dir
        filename = os.path.join(WORKING_DIR, "results/Normal/FastSA-interval-10-appCount-4.vec")
