...
def collect_link_failure_measured():
    output_csv = os.path.join(OUTPUT_DIR, f"link_failure_measured_data.csv")
...
def collect_node_failure_measured():
    output_csv = os.path.join(OUTPUT_DIR, f"node_failure_measured_data.csv")
    params_list = ["utility:vector", "meetDlPkt:vector"]
