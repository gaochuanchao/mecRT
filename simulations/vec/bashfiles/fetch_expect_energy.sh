...
# Extracts a specific scalar (e.g., savedEnergy:sum)
...
SCALAR_NAME="savedEnergy:sum"             # Just the scalar name
...
OUTPUT_CSV="${OUTPUT_DIR}/scheAll_${SCHE_ALL}_countExeTime_${COUNT_EXE_TIME}_expected_energy_sum.csv"
...
for file in "$INPUT_DIR"/*.sca; do
    ...
    # e.g., scalar VEC.scheduler.vecScheduler savedEnergy:sum 147260203.51707
